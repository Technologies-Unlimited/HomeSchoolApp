...
export function buildAnnouncementEmailHtml({
  ...
  return `
    <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;max-width:560px;margin:0 auto;color:#1e293b;">
      ...
      <h2 style="font-size:20px;font-weight:600;margin:0 0 12px;">${safeTitle}${priorityBadge}</h2>
      <div style="font-size:14px;line-height:1.7;color:#475569;white-space:pre-wrap;">${safeContent}</div>
      <p style="margin-top:20px;font-size:12px;color:#94a3b8;">Posted by ${safeAuthor}</p>
